...
<title><%=sysname%> - 企业注册第四步</title>
<!--#include file="inc/uploadcontrol.asp" -->
<%
call WhereTable("identity.png","企业注册第四步：上传企业资质材料")
%>
...
<input type="hidden" name="gotourl" value="company_reg_fifth">
<input type="hidden" name="id" value="<%=request("id")%>">
<input type="hidden" name="companyrealname" value="<%=request("companyrealname")%>">
<tr>
	<td class="list_header_required" width="15%">上传资质材料<br><font color="#FF0000">请上传公司（企业）资质</font></td>

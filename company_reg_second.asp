...
<title><%=sysname%> - 企业注册第二步</title>
<!--#include file="inc/Md5.asp" -->
<%
call WhereTable("identity.png","企业注册第二步：阅读注册须知")
%>
...
<tr>
	<td class="list_command" align="center"><input class='form_submit' type='button' name='cmd' id='cmd' value=' 我同意 ' onClick="window.location.href='company_reg_third.asp'">

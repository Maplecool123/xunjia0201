...
for i=1 to allno
	...
	total(i,2)=gettotalitem("tender","tenderclass","材料"," and ifzu=1 and ifdel=0"&sqltime)
	total(i,3)=gettotalitem("tender","tenderclass","设备"," and ifzu=1 and ifdel=0"&sqltime)
	total(i,4)=gettotalitem("tender","tenderclass","综合"," and ifzu=1 and ifdel=0"&sqltime)
...
<tr class='grid_header'>
	<td colspan="4"><strong>发布项目：<%=allzhaobiao1%>&nbsp;&nbsp;&nbsp;&nbsp;材料类：<%=allzhaobiao2%>&nbsp;&nbsp;&nbsp;&nbsp;设备类：<%=allzhaobiao3%>&nbsp;&nbsp;&nbsp;&nbsp;综合类：<%=allzhaobiao4%></strong></td>
</tr>
</form>
</table>

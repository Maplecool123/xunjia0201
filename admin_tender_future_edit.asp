...
if request.form("action")="saveadd" then
	...
	focusman=shownamestrnull("focusman","tender","djh",request.form("djh")," and ifzu=1")
	conn.execute("delete from [tender] where djh='"&request.form("djh")&"'")
	conn.execute("delete from [competitive] where djh='"&request.form("djh")&"'")
	...
	call HintAndTurn("竞价信息修改成功！"&addstr,"admin_tender_future.asp?"&gourl)
end if
%>
...
<tr>
	...
	<td class="list_required" colspan="2"><%=rs_t("djh")%></td>
</tr>
<tr>
...
<tr>
	...
	<td class="list_command" colspan="2"><input class='form_submit' type='submit' name='cmd' id='cmd' value=' 确定 ' onClick="return checkenter()">

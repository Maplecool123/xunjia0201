...
call WhereTable("identity.png","竞价管理")
...
gourl="needtime1="&nowneedtime1&"&needtime2="&nowneedtime2&"&needtime3="&nowneedtime3&"&needtime4="&nowneedtime4&"&start_date="&nowstart_date&"&end_date="&nowend_date&"&tender_class="&nowtender_class&"&checkstyle="&nowcheckstyle&"&checkcondition="&nowcheckcondition&"&checkstatue="&nowcheckstatue&"&keyword1="&nowkeyword1&""
...
<tr class="grid_odd" align="center">
	...
	<td class="grid_cell"><input type='button' value='新增' onClick="location.href='admin_tender_add.asp?fromurl=admin_tender'" class='form_submit'></td>
</tr>
</form>
</table>
<%

...
call WhereTable("identity.png","添加企业第一步：填写基本信息")
...
if request.form("action")="saveadd" then
	...
	call HintAndTurn("基本信息设置成功，下一步上传企业资质材料！","admin_company_add_second.asp?id="&shownamestrnull("id","company","companyname",nowcompanyname,"")&"&companyrealname="&nowcompanyrealname)
end if
%>

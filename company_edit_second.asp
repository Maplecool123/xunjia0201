...
<input type="hidden" name="gotourl" value="company_edit_third">
...
<tr>
	...
	<td class="list_required" colspan="2">
		...
		<tr valign="middle">
			<td class="list_required">竞价采购承诺书：　　　
			<input type="file" name="companyfile1" id-"companyfile1" style="width:400" class="form_button"></td>
			<input type="hidden" name="allpaixu1" id="allpaixu1" value="1">
		...
		<tr valign="middle">
			<td class="list_required">企业法人营业执照：　　
			<input type="file" name="companyfile2" id="companyfile2" style="width:400" class="form_button"></td>
			<input type="hidden" name="allpaixu2" id="allpaixu2" value="2">
		...
		<tr valign="middle">
			<td class="list_required">税务登记证：　　　　　
			<input type="file" name="companyfile3" id="companyfile3" style="width:400" class="form_button"></td>
			<input type="hidden" name="allpaixu3" id="allpaixu3" value="3">
		...
		<tr valign="middle">
			<td class="list_required">组织机构代码证：　　　
			<input type="file" name="companyfile4" id="companyfile4" value="" style="width:400" class="form_button">
			<input type="hidden" name="allpaixu4" id="allpaixu4" value="4">

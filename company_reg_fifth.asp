...
<title><%=sysname%> - 企业注册第五步</title>
<!--#include file="inc/uploadcontrol.asp" -->
<%
call WhereTable("identity.png","企业注册第五步：上传企业以往合同")
%>
...
<input type="hidden" name="gotourl" value="index">
<input type="hidden" name="companyrealname" value="<%=request("companyrealname")%>">
<tr>
	<td class="list_header_required" width="15%">上传合同<br><font color="#FF0000">请上传公司（企业）以往合同盖章扫描件至少1份</font></td>
	<td class="list_required" colspan="0">
		<table class='list_table' width='100%' cellpadding='0' cellspacing='1' border='0'>
		<tr valign="middle">

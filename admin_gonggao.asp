...
if request("action")="delall" then
	...
	'response.write "delete from [gonggao] where id="&id(i)&"<br>"
		conn.execute("delete from [gonggao] where id="&id(i)&"")
	next
	'response.end
...
<tr class="grid_odd" align="center">
	...
	<td class="grid_cell"><input type='button' value='新增' onClick="location.href='main_main.asp'" class='form_submit'></td>
